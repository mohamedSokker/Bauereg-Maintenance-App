...
const Problem = ({ navigation, socket, userID }) => {
  useEffect(() => {
    const appExit = () => {
      navigation.goBack();
      return true;
  ...
  const handleConfirm = async () => {
    try {
      ...
      copied = { ...copied, Problem: desc, Working_Hours: wh };
      setReportDetails((prev) => ({
        ...prev,
        Problem: desc,
        Working_Hours: wh,
      ...
      <View style={styles.view4}>
        ...
        <View style={styles.view5}>
          <Text style={styles.txt4}>
            {reportDetails?.Problem === null
              ? "No result now please add Problem"
          ...
          <View style={styles.view7}>
            <View style={styles.view8}>
              <View style={styles.view9}>
                <Text style={styles.txt5}>Add Problem</Text>
                <TouchableOpacity onPress={() => setIsAddClicked(false)}>
                  <Text style={styles.txt6}>Close</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={handleConfirm}
                  disabled={!desc || !wh ? true : false}
                  style={{ opacity: !desc || !wh ? 0.7 : 1 }}
                >
